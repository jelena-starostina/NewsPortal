<?php
// newsAddForm.php - единый файл (форма + обработка + layout)
    ...
    <form method="POST" action="newsAddResult" enctype="multipart/form-data">
        <table class="table table-bordered">
            ...
            <tr>
                <td>Picture</td>
                <td>
                    <div><input type="file" name="picture" style="color:black;"></div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <button type="submit" class="btn btn-primary" name="save">
                        <span class="glyphicons glyphicons-plus"></span> Сохранить
                    </button>
                    <a href="newsAdmin" class="btn btn-default btn-success">Назад к списку</a>
                </td>
            </tr>
        </table>
    </form>
